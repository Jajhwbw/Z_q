...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/ze_in22")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/+gd7IDYDFObU5NzE8"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/ucriss")],
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ [{OWNER_NAME}]""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("The owner of the source 🧑‍✈️", url=f"https://t.me/ze_in22")],
...
[InlineKeyboardButton("Bot Group 🤖", url=f"https://t.me/+gd7IDYDFObU5NzE8"),InlineKeyboardButton("Channel Updates 🐉", url=f"https://t.me/ucriss")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
