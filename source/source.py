...
async def alive(client: Client, message):
    ...
    alive = f"""╭──── • ◈ • ────╮
么 [𝑫𝒆𝒗 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/ze_in22).
么 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆](ucriss).
么 [𝑮𝒓𝒐𝒖𝒑 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/HAR_I7).
╰──── • ◈ • ────╯
🚦𝑻𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 ."""

    await message.reply_photo(
        photo=f"https://telegra.ph/file/c594786a4b3e66797ac1d.mp4",
        caption=alive,
...
async def deev(client: Client, message: Message):
     if await joinch(message):
            return
     user = await client.get_chat(chat_id="ze_in22")
